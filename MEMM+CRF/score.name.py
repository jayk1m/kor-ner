...
def score (keyFileName, responseFileName):
    ...
    print("\n" + str(correct) + " out of " + str(correct + incorrect) + " tags correct")
...
score('./KOREAN_NAME_CORPUS/KOR_dev.name', './outputs/response.name')
score('./KOREAN_NAME_CORPUS/KOR_test.name', './outputs/KOR_test.name')
